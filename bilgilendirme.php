...
<form class="form-horizontal">
  ...
  <ul class="pagination">
    ...
    <li class="page-item"><a class="page-link" href="saglik.php">Sağlık Bilgisi Formu</a></li>
	 ...
	 sürdürmekle kalmamış, aynı zamanda pek değişmeden elektronik dizgiye de sıçramıştır. 1960'larda Lorem Ipsum pasajları da
...
Yinelenen bir sayfa içeriğinin okuyucunun dikkatini dağıttığı bilinen bir gerçektir. Lorem Ipsum kullanmanın amacı, sürekli
 'buraya metin gelecek, buraya metin gelecek' yazmaya kıyasla daha dengeli bir harf dağılımı sağlayarak okunurluğu artırmasıdır.
